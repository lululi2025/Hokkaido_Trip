...
export default function App() {
  ...
  // 🌟 新增：PWA 與加入主畫面 App Icon 設定
  useEffect(() => {
    const APP_NAME = "北海道之旅";
    // 使用高畫質的北海道雪景圖，並透過 URL 參數裁切成 512x512 的完美正方形作為 App Icon
    const ICON_URL = "https://images.unsplash.com/photo-1480796927426-f609979314bd?auto=format&fit=crop&w=512&h=512&q=80";

    // 1. 動態建立 PWA Manifest (主要給 Android Chrome 使用)
    const manifest = {
      name: "北海道8天7夜 春季自駕尋味之旅",
      short_name: APP_NAME,
      start_url: ".",
      display: "standalone", // 啟動全螢幕模式，隱藏瀏覽器網址列
    ...
    return () => {
      ...
      document.head.removeChild(metaStatusBarStyle);
