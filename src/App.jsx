          ...
          <div className="absolute top-4 right-6">
            {user ? (
              <div className="flex items-center gap-2">
                ...
                <button onClick={handleLogout} className="text-xs bg-white/20 hover:bg-white/30 text-white px-3 py-1.5 rounded-full transition-all">登出</button>
              </div>
            ) : (
              <button onClick={handleGoogleLogin} className="flex items-center gap-2 bg-white text-blue-700 font-semibold text-sm px-4 py-2 rounded-full shadow hover:shadow-md transition-all">
