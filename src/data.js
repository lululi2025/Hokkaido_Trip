...
export const INITIAL_ITINERARY = [
  ...
  },
  {
    ...
    activities: [
      ...
      {
        time: "16:00", duration: "1小時", location: "入住：Nord 小樽飯店",
        tags: ["🏨 絕佳住宿", "📍 運河第一排"],
        description: "辦理入住手續。這間飯店就在小樽運河正對面，擁有絕佳的浪漫運河景觀！",
        transport: "步行或自駕 (飯店附設停車場，先卸下行李)",
        detailInfo: "【運河第一排的浪漫】\nNord 小樽飯店 (Hotel Nord Otaru) 地理位置無可挑剔，過個馬路就是小樽運河！外觀是充滿歐洲風情的大理石建築，頂樓還有可以俯瞰運河與日本海的酒吧。\n\n【停車與行程建議】\n由於今晚住小樽，自駕的車子可以直接停在飯店停車場（需付費），放好行李後就能輕鬆漫步小樽運河的夜景，享受沒有一日遊團客的寧靜小樽。",
        icon: Bed, mapQuery: "Hotel Nord Otaru",
        imageUrl: "",
        sourceLinks: [
          { name: "Marktrip：小樽住宿推薦", url: "https://www.google.com/search?q=Marktrip+小樽住宿", type: "web" },
          { name: "台灣Vlog：Nord小樽飯店開箱", url: `https://www.youtube.com/results?search_query=${encodeURIComponent("台灣 Vlog Nord 小樽飯店")}`, type: "youtube" }
        ]
      },
      {
        time: "17:30", duration: "1.5小時", location: "小樽天狗山夜景",
        tags: ["⭐ 非常熱門", "📸 北海道三大夜景"],
        description: "搭乘纜車上山，欣賞與函館、藻岩山並列的北海道三大夜景。",
        transport: "自駕 (約 15分) ➝ 轉乘纜車",
        detailInfo: "【經典電影取景地】\n天狗山不僅是北海道三大夜景之一，更是經典電影《情書》的取景地！從山頂可以將小樽市區、小樽港與石狩灣的絕美景色盡收眼底。因為今晚住在小樽，終於有充裕的時間可以上山看夜景了！",
        icon: Camera, mapQuery: "小樽天狗山纜車",
        imageUrl: "",
        sourceLinks: [
          { name: "波比看世界：小樽天狗山", url: "https://www.google.com/search?q=波比看世界+天狗山", type: "web" },
          { name: "台灣Vlog：天狗山夜景實錄", url: `https://www.youtube.com/results?search_query=${encodeURIComponent("台灣 Vlog 小樽天狗山")}`, type: "youtube" }
        ]
      },
      {
        time: "19:30", duration: "1.5小時", location: "晚餐：若雞時代 鳴門本店",
        tags: ["⭐ 非常熱門", "🍗 在地靈魂美食"],
        description: "品嚐小樽在地人最愛的靈魂美食「炸半雞」，皮脆肉嫩超多汁！",
        transport: "自駕返回市區 或 步行",
        detailInfo: "【小樽不只海鮮】\n誰說來小樽只能吃海鮮？「若雞時代 鳴門 (なると)」是小樽在地人極度推崇的老字號名店。招牌的「炸半雞（若鶏時代なると 半身揚げ）」外皮炸得金黃酥脆，一口咬下肉汁大爆發，搭配一杯冰涼的啤酒，絕對是小樽夜晚最棒的享受！",
        icon: Utensils, mapQuery: "若雞時代 鳴門本店",
        imageUrl: "",
        sourceLinks: [
          { name: "娜塔蝦：若雞時代食記", url: "https://www.google.com/search?q=娜塔蝦+若雞時代", type: "web" },
          { name: "台灣Vlog：小樽炸半雞試吃", url: `https://www.youtube.com/results?search_query=${encodeURIComponent("台灣 Vlog 若雞時代 鳴門")}`, type: "youtube" }
        ]
      }
    ]
  },
  {
    day: 6,
    date: "2026/04/02",
    title: "札幌市區切換：還車、秘境與爆買夜",
    activities: [
      {
        time: "09:00", duration: "1.5小時", location: "退房出發：Nord 小樽 ➝ 札幌還車",
        tags: ["🏨 退房", "🚗 交通節點"],
        description: "11:00前退房即可，開車前往札幌市區辦理還車手續，省下高昂停車費。",
        transport: "自駕 (約 40km / 50分) ➝ 札幌還車",
        detailInfo: "【省錢內行操作】\n享用完 Nord 小樽的美味早餐後，驅車前往札幌。由於札幌市區交通擁擠且多數飯店停車皆需額外收費（每晚高達 1,500~2,500 日圓不等），強烈建議抵達札幌後立刻前往附近的營業所辦理「異地還車」。將行李寄放在飯店或車站置物櫃後，後續行程全靠大眾運輸！",
        icon: Car, mapQuery: "札幌車站",
        imageUrl: "",
        sourceLinks: [
          { name: "泰莎出去玩：日本自駕還車", url: "https://www.google.com/search?q=泰莎出去玩+日本自駕", type: "web" },
          { name: "台灣Vlog：日本還車注意事項", url: `https://www.youtube.com/results?search_query=${encodeURIComponent("台灣 Vlog 日本租車 還車")}`, type: "youtube" }
        ]
      },
      {
        time: "11:00", duration: "1.5小時", location: "早午餐：二條市場 或 湯咖哩",
        tags: ["⭐ 非常熱門", "🍛 札幌必吃"],
        description: "抵達札幌後，先填飽肚子。可選擇海鮮早午餐或札幌靈魂美食湯咖哩。",
        transport: "步行或地鐵",
        detailInfo: "【兩派吃貨選擇】\n選項 A：如果想念海鮮，可以前往「二條市場」找家現烤海鮮攤位，品嚐現烤帆立貝與牡蠣。\n選項 B：直奔札幌靈魂美食「湯咖哩 (Soup Curry)」！推薦排隊名店 GARAKU 或 Suage+，幾十種香料熬煮的藥膳湯頭配上酥炸北海道時蔬，絕對驚豔。",
      ...
      {
        time: "17:30", duration: "1.5小時", location: "晚餐：根室花丸迴轉壽司 (Stellar Place店)",
        tags: ["⭐ 非常熱門", "🍣 完美離峰"],
        description: "產地直送的高CP值壽司，利用離峰時段避開可怕的人潮。",
        transport: "搭乘巴士與JR返回「札幌車站」Stellar Place 6樓",
        detailInfo: "【部落客離峰神操作】\n去完支笏湖回到札幌車站大約下午 5 點左右，這時候去抽號碼牌吃永遠大排長龍的『根室花丸』，能在晚餐尖峰前完美卡位！\n\n【必點攻略】\n入座後必點菜色包含：疊了兩層的「生干貝握壽司」、濃郁無比的「花咲蟹鐵砲汁（大碗螃蟹味噌湯）」，以及浮誇的「醬油漬鮭魚卵」，性價比極高。",
        icon: Fish, mapQuery: "根室花丸 Stellar Place店",
        imageUrl: "",
        sourceLinks: [
      ...
      {
        time: "19:30", duration: "2小時", location: "狸小路商店街與薄野散策",
        tags: ["⭐ 非常熱門", "🛍️ 爆買聖地"],
        description: "北海道最大的商店街，開啟藥妝採購與探路，體驗夜間聖代。",
        transport: "步行或地鐵",
        detailInfo: "【札幌的繁華中心】\n狸小路是全長一公里的巨型拱廊商店街，無論晴雨都能輕鬆逛街。這裡是購買伴手禮與藥妝（大國、松本清、唐吉訶德）的絕佳戰場。逛完後可順勢往南走到「薄野（すすきの）」，與著名的 Nikka 威士忌大看板合影。\n\n【體驗：夜間聖代文化】\n逛累了，跟著在地人體驗札幌獨有的「夜間聖代（シメパフェ）」。札幌人習慣以一份精緻如藝術品的水果聖代作為夜晚收尾！",
  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        detailInfo: "【無縫接軌市區核心】\n從圓山公園站搭乘地鐵東西線，只需 5 分鐘就能直達「大通站」。大通公園是札幌的心臟，四月初雖然還沒有花海，但在微涼的春風中散步非常舒服。強烈建議在黃昏時分登上「札幌電視塔」，看著市區的華燈初上，準備迎接美好的晚餐！",
      ...
      {
        time: "18:30", duration: "2小時", location: "晚餐：達摩 (だるま) 成吉思汗烤肉",
        tags: ["⭐ 非常熱門", "🥩 宵夜首選"],
        description: "炭火鐵鍋烤出的頂級羊肉，札幌宵夜的代名詞。",
        transport: "地鐵或步行至「薄野站 (すすきの)」",
...
export const SHOPPING_ITEMS = [
  ...
  {
    category: "🍰 經典必敗甜點",
    icon: Gift, color: "text-sky-600", bg: "bg-sky-50", border: "border-sky-200",
  ...
  {
    category: "🍘 鹹食零嘴與在地挖寶",
    icon: ShoppingBag, color: "text-yellow-600", bg: "bg-yellow-50", border: "border-yellow-200",
  ...
  {
    category: "🍶 在地特色酒類",
    icon: Droplets, color: "text-indigo-600", bg: "bg-indigo-50", border: "border-indigo-200",
  ...
  {
    category: "💊 藥妝保養與限定香氛",
    icon: Palmtree, color: "text-emerald-500", bg: "bg-emerald-50", border: "border-emerald-200",
  ...
  {
    category: "💊 藥妝保養與限定香氛",
    icon: ShoppingBag, color: "text-pink-500", bg: "bg-pink-50", border: "border-pink-200",
  ...
  {
    category: "💊 藥妝保養與限定香氛",
    icon: Sparkles, color: "text-indigo-500", bg: "bg-indigo-50", border: "border-indigo-200",
